...
import type { InterestRecord } from '../../../store/types';

interface InterestCalculatorViewProps {
  interestHistory: InterestRecord[];
  addInterestRecord: (record: InterestRecord) => void;
  deleteInterestRecord: (id: string) => void;
        ...
        {type === 'CI' && (
          <div className="flex flex-col gap-1">
            ...
            <CustomSelect
              ...
              onChange={(val) =>
                setCompoundFrequency(val as 'annually' | 'semi-annually' | 'quarterly' | 'monthly')
              }
              options={[
                ...
                {interestHistory.map((record) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant={record.type === 'SI' ? 'info' : 'warning'}>
                        {record.type}
                      </Badge>
                    </div>
                    ...
                    <div className="flex justify-between items-end mt-1 pt-2 border-t border-border/50">
                      <div>
                        ...
                        <p className="font-semibold text-sm">
                          ₹{Math.round(record.totalAmount).toLocaleString('en-IN')}
                        </p>
                      </div>
                      <button
